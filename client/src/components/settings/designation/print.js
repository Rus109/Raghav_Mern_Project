...
class printDesignation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      designation: "",
  ...
  render() {
   ...
   Print
      ...
      <Link to="/api/designation" className="btn btn-dark mt-4 ml-4" id="hide">
      Back to List
      </Link>
      <div className="mb-4" style={{border: "2px solid black", marginTop: "4%"}}> 
       <Logo/>
       <h3 className="text-center mt-3">Designation Details</h3>
     <div className="mt-5" style={{paddingLeft:"25%", fontSize: "14px"}}>
     <div className="row">
    <div className="col-4" style={{fontWeight: "bold"}}><p>Designation:</p></div>
    <div style={{border: "1px solid black", padding: "5px", width: "200px"}}>{this.state.designation}</div>
     </div>
     <br/>
...
export default printDesignation;
