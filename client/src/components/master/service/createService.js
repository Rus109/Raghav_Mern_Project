...
class createServiceCenter extends Component {
  ...
  onSubmit(e) {
    ...
    const obj = {
      ...
      serviceproviderid: this.state.srvprd,
    ...
    console.log(this.state.srvprd);
    console.log(obj);
    axios
      .post("http://localhost:4000/api/servicecenter/add", obj)
      ...
      <div className="container mt-5">
        <div className="card" style={{ marginBottom: "5%" }}>
          <div className="card-header text-white">
            <h3 className="text-center">Add New Service Center</h3>
          </div>
